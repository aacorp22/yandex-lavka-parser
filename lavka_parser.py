...
url_energeticks = "https://lavka.yandex.ru/213/category/energy_beer"
...
for good in soup.find_all('div', class_="p10zc8qs"):
    ...
    comment_text = good.find_all("span", class_ = "a1dq5c6d")[1]
...
df.to_excel('snacks.xlsx', index=False)

with open("all_snacks.html", "w", encoding="utf-8") as file:
